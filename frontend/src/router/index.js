  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'knowledge/new', name: 'KnowledgeCreate', component: () => import('../views/KnowledgeForm.vue'), meta: { title: '新增知识' } },
        { path: 'knowledge/:id', name: 'KnowledgeForm', component: () => import('../views/KnowledgeForm.vue'), meta: { title: '知识详情' } },
        ...
        { path: 'work-order-imports', name: 'WorkOrderImports', component: () => import('../views/ImportWorkOrders.vue'), meta: { title: '历史工单导入', roles: ['SUPERVISOR', 'ADMIN'] } },
