...
- **多条疑似原因必须用"第一、第二、第三……"分条罗列并按可能性排序，严禁用"或、顿号、和"等挤在同句并列**（如"液压压力不足或油温过高"）；分条后仍需收敛到优先方向
- **分析不得用"和案例很像/与 XX 案例相似"等套近乎话术**，推理依据直接讲机理
...
- **多条疑似原因必须用"第一、第二、第三……"分条罗列并按可能性排序，严禁用"或、顿号、和"等挤在同句并列**；分条后仍需收敛到优先方向
- **分析不得用"和案例很像/与 XX 案例相似"等套近乎话术**，推理依据直接讲机理
- 输出严格 JSON，不要 markdown 代码块
